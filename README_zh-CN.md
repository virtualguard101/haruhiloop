...
├─ src/
│  ├─ assets/                     # ASCII 资源
│  └─ haruhiloop_cli/             # Python 包（CLI/TUI + 分层核心）
├─ tests/                         # Python 测试集
...
结局条件与优先级实现见 `src/haruhiloop_cli/domain/rules/ending_conditions.py`，长剧情文本见 `src/haruhiloop_cli/narrative/ending_epilogues.py`。
